function adicionarFilme() {
  ...
  var erroFilmeAdicionado = document.querySelector('#erro-adiciona-filme')

  //Se a variável filmeFavorito for do tipo texto e terminar com outro texto que tenha a extensão .jpg
  if (filmeFavorito.endsWith('.jpg')) {
    listarFilmesNaTela(filmeFavorito)
    erroFilmeAdicionado.innerHTML = ""
  }
  else {
    erroFilmeAdicionado.innerHTML = "Imagem não encontrada! Digite apenas imagens que tenham o link com a extensão .jpg/ Exemplo: https://m.media-amazon.com/images/M/MV5BMTk0NzcxMjYwNF5BMl5BanBnXkFtZTcwMTI4MTIxMw@@._V1_UX182_CR0,0,182,268_AL_.jpg"
  }
